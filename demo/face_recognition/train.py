...
from tlxcv.models.face_recognition import RetinaFace
...
if __name__ == "__main__":
    ...
    _all = Wider("/home/aistudio-user/userdata/tlxzoo/widerface", "train", limit=1000)
    train_dat, val_dat = _all.split_train_test(
        transform_group=(transform.train_call, transform.test_call)
    )
    train_data = DataLoader(train_dat, batch_size=4, shuffle=True)
