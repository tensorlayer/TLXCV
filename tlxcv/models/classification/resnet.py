...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=\
        ...
        self.conv1 = nn.GroupConv2d(padding=1, stride=stride, in_channels=\
            inplanes, out_channels=planes, kernel_size=3, b_init=(),
        ...
        self.conv2 = nn.GroupConv2d(padding=1, in_channels=planes,
            out_channels=planes, kernel_size=3, b_init=(), data_format=\
            'channels_first')
...
class BottleneckBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=\
        ...
        self.conv1 = nn.GroupConv2d(in_channels=inplanes, out_channels=\
            width, kernel_size=1, b_init=(), padding=0, data_format=\
            'channels_first')
        ...
        self.conv2 = nn.GroupConv2d(padding=dilation, stride=stride,
            ...
            kernel_size=3, b_init=(), n_group=groups, data_format=\
            'channels_first')
        ...
        self.conv3 = nn.GroupConv2d(in_channels=width, out_channels=planes *
            self.expansion, kernel_size=1, b_init=(), padding=0,
            data_format='channels_first')
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, depth=50, width=64, num_classes=1000,
        ...
        self.conv1 = nn.GroupConv2d(kernel_size=7, stride=2, padding=3,
            in_channels=3, out_channels=self.inplanes, b_init=(),
            data_format='channels_first')
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilate=False):
        ...
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential([nn.GroupConv2d(stride=stride,
                ...
                expansion, kernel_size=1, b_init=(), padding=0, data_format
                ='channels_first'), batch_norm(num_features=planes * block.
                expansion, data_format='channels_first')])
        layers = []
